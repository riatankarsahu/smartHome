...
REM
REM Generated by Vivado on Sun Apr 10 19:22:14 +0200 2022
...
echo "xvlog --incr --relax -L uvm -prj CPU_vlog.prj"
call xvlog  --incr --relax -L uvm -prj CPU_vlog.prj -log xvlog.log
